...
const CategoryInputField = ({ id, name, type, value, onChange, index, deleteInputField,deleteCategoryInputField }) => {
  return (
    <div className="flex mb-5">
      ...
      <div className={deleteCategoryInputField === "true" ? "flex ml-auto" : "flex ml-auto hidden"}>
        <button type="button"
